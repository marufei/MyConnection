...
public class PicassoUtlis {
    ...
    public static void img(String imageUrl, ImageView imageView) {
        ...
        Picasso.with(context).load(imageUrl).placeholder(R.mipmap.error_pic_s).error(R.mipmap.error_pic_s).into(imageView);
    }
    ...
    public static void rountimg(String imageUrl, ImageView imageView) {
        ...
        Picasso.with(context).load(imageUrl).error(R.drawable.vector_drawable_circle).transform(new CircleTransform()).into(imageView);
    }
