...
public class ImageCycleView extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        mAdvPager.setOffscreenPageLimit(10);
     ...
     */
    public void setBeans(List<BannerEntity.BannersBean> dBeans, Listener imageCycleViewListener) {
...
//        private List<BannerBean> mAdList = new ArrayList<>();
        private List<BannerEntity.BannersBean> beans = new ArrayList<>();
        ...
        public ImageCycleAdapter(Context context, List<BannerEntity.BannersBean> dBeans, Listener listener) {
...
//			return mAdList.size();
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            String imageUrl = beans.get(position % beans.size()).getImg_url();
    ...
    public interface Listener {
         ...
         * @param imageView
         */
        void onImageClick(BannerEntity.BannersBean bean, View imageView);
    }
